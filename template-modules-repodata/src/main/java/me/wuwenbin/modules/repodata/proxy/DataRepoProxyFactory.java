 ...
 * @author Wuwenbin
 */
public class DataRepoProxyFactory<T> implements InvocationHandler {
    ...
    public T newInstance() {
        ...
        return (T) Proxy.newProxyInstance(dataInterface.getClassLoader(), new Class[]{dataInterface}, this);
    }
